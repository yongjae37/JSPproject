...
<body class="is-preload">
	...
	<section id="contact">
		<div class="inner">
			<section>
				<form method="post" action="/mysiteB/product?a=insertReview&proNo=${proNo}" enctype="multipart/form-data">
					...
					<div class="fields">
						...
						<div class="input_wrap">
							<label className="input-file-button" for="input_imgs"> <img
								...
								src="images/main.png">
							</label> <input type="file" id="input_imgs" style="display: none;"
								multiple='multiple' />
						...
						<div class="field">
							...
							<input name="title" id="message" type="text"/>
						</div>
						<div class="field">
							<label for="message">Message</label>
							<textarea name="content" id="message" rows="6" style = "width : 600px; margin-left : 20px"></textarea>
						</div>
					</div>
					<ul class="actions">
