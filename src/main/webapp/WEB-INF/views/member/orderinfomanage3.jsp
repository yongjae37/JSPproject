...
<body class="is-preload">
				...
				<div class="col-6 col-12-medium">
					...
					<div class="row">
						...
						<div class="col-3 col-3-small">
							...
							<ul>
								<a href="#" class="list-group-item">주문관리</a>
								<br>
						...
						<div class="col-9 col-12-medium">
							...
							<div class="dropdown">
								<h3 class="dropbtn">
										<a href="/mysiteB/orderInfo?a=after">배송 완료된 내역</a>
									</h3>
									<div class="dropdown-content">
										<a href="/mysiteB/orderInfo?a=managelist">실시간 주문 내역</a> <a
											href="/mysiteB/orderInfo?a=before">배송 처리 전 내역</a>
									</div>
								</div>
								<table>
									<thead>
									...
									<tbody>
										<c:forEach items="${list}" var="vo">
											...
											<tr>
												<td>${vo.orderDate}</td>
												<td><a
													href="/mysiteB/orderInfo?a=specific&orderNo=<%=vo.getOrderNo()%>">${vo.memId}</a></td>
												<td>${vo.proName}</td>
												<td>${vo.totalPrice}</td>
												<c:choose>
	...
	<div class="popupLayer">
		...
		<form method="post"
			action="/mysiteB/orderInfo?a=change&orderNo=<%=vo.getOrderNo()%>"
			name="form">
