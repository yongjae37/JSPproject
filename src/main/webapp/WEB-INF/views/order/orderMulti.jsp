...
<body class="is-preload">
	<form class="form-signin" id="mypage-form" name="modifyform"
		method="post" action="/mysiteB/orderInfo">
		<input type="hidden" name="a" value="multiInsert" />
							...
							<table>
								...
								<c:forEach items="${cartlist}" var="vo">>
									<tr>
										...
										<th>${vo.proName}</th>
										<th>${vo.amount}</th>
										<th><c:out value="${vo.proPrice * vo.amount}"></c:out></th>
								...
								<div id="noneDiv2" style="display: none;">
									...
									<div class="col-12">
										...
										<ul class="actions">
											...
											<li><input type="text" name="doro" id="memDoro" value=""
												placeholder="도로명주소"></li>
											<li><input type="text" name="jibun" id="memJibun"
